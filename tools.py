...
DEFAULT_COMMANDS = {
    ...
    'help': '**Kömək** - Əmr kateqoriyalarını və ətraflı kömək kartlarını göstər.\n\n**İstifadə:** `[prefix]help [əmr | kateqoriya | səhifə]`',
    'helpset': '**Kömək Ayarı** - Kömək menyusunu fərdiləşdir (MongoDB-də saxlanılır).\n\n**İstifadə:** `[prefix]helpset <header|footer|style|perpage|emoji> <dəyər>`',
    'helpreset': '**Köməyi Sıfırla** - Kömək menyusu ayarlarını standart hala qaytar.\n\n**İstifadə:** `[prefix]helpreset`',
    'setalivetitle': '**Alive Başlığı** - Alive mesajının başlığını dəyiş.\n\n**İstifadə:** `[prefix]setalivetitle <başlıq>`',
    'setalivelogo': '**Alive Loqosu** - Alive şəklini/videosunu təyin et.\n\n**İstifadə:** `[prefix]setalivelogo` (şəklə cavab verin)',
    'setalivetemplate': '**Alive Şablonu** - Bütün alive mesajını öz şablonunla əvəz et.\n\n**İstifadə:** `[prefix]setalivetemplate <şablon>`',
    'alivemedia': '**Alive Medyası** - Alive mesajını şəkilli/şəkilsiz göndər.\n\n**İstifadə:** `[prefix]alivemedia [on|off]`',
    'alivesettings': '**Alive Ayarları** - Cari alive ayarlarını göstər.\n\n**İstifadə:** `[prefix]alivesettings`',
    'resetalive': '**Alive-ı Sıfırla** - Bütün alive ayarlarını sıfırla.\n\n**İstifadə:** `[prefix]resetalive`',
    'update': '**Yenilə** - Kodu git-dən yenilə və botu yenidən başlat.\n\n**İstifadə:** `[prefix]update [force]`',
    'exec': '**Exec Əmri** - Shell və ya kod əmrini icra et.\n\n**İstifadə:** `[prefix]exec <cmd>`',
}
DEFAULT_CATEGORIES = {
    'ℹ️ MƏLUMAT': ['alive', 'ping', 'stats', 'info', 'status', 'sessions', 'help', 'helpset', 'helpreset', 'setalivetext', 'setalivetitle', 'setemoji', 'setalivelogo', 'setalivetemplate', 'alivemedia', 'alivesettings', 'resetalive', 'resetallalive'],
