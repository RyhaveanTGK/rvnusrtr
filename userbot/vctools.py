...
CreateGroupCall(
        ...
        await message.edit("Qrup zəngini başlatmaq uğursuz oldu")
        ...
        if isinstance(chat_peer, (InputPeerChannel, InputPeerChat)):
            ...
            if full_chat is not None:
                ...
                if group_call is not None:
                    ...
                    await message.edit_text("Qrup zəngi bitirildi")
                    return
        await message.edit_text("Aktiv qrup zəngi tapılmadı")
    except Exception as e:
        logger.warning(f"End group call failed: {e}")
        await message.edit_text("Zəngi bitirərkən nəsə səhv getdi.")
